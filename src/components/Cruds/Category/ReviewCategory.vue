        ...
        <v-window v-model="tabs">
          ...
          <v-window-item :value="1" class="p-3">
            <v-card
              ...
              v-for="(category, index) in category_en"
              :key="index"
              :style="
            ...
            >
              <v-layout>
                <v-row class="px-6 mt-2">
                  ...
                  <v-col cols="12" sm="6" md="4">
                    <div class="d-label">{{ $t("approved_by_en") }}</div>
          ...
          <v-window-item :value="2" class="p-3">
            <v-card
              ...
              v-for="(category, index) in category_ar"
              :key="index"
              :style="
                'border-color:' + getStatusColor(category.approval_status)
              "
...
export default {
  ...
  methods: {
    fetchCategoryDetails() {
      this.loader = true;
      this.$axios
        .get(process.env.VUE_APP_API_URL_ADMIN + "fetch-category-details", {
          params: {
