            ...
            >
              <v-layout>
                <v-row class="px-6 mt-2">
                  ...
                  <v-col cols="12" sm="6" md="3">
                    <div class="d-label">{{ $t("media_type_en") }}</div>
            ...
            >
              <v-layout>
                <v-row class="px-6 mt-2">
                  ...
                  <v-col cols="12" sm="6" md="3">
                    <div class="d-label">{{ $t("media_type_ar") }}</div>
                    <div>{{ event.media_type }}</div>
                  </v-col>
                  <v-col cols="12" sm="6" md="3">
...
export default {
  ...
  methods: {
    ...
    fetchsliderDetails() {
      this.loader = true;
      this.$axios
        .get(process.env.VUE_APP_API_URL_ADMIN + "fetch-slider-details", {
          params: {
    ...
    updateApprovalStatus(comment_en = "", comment_ar = "") {
      this.loader = true;
      this.$axios
        .post(process.env.VUE_APP_API_URL_ADMIN + "update-slider-approval", {
