        ...
        <v-window v-model="tabs">
          ...
          <v-window-item :value="1" class="p-3">
            <v-card
              ...
              v-for="(promotion, index) in promotions_en"
              :key="index"
              :style="
                'border-color:' + getStatusColor(promotion.approval_status)
              "
            >
              <v-layout>
                <v-row class="px-6 mt-2">
                  ...
                  >
                    ...
                    <div v-if="promotion.review_comment">
              ...
              >
                ...
                <v-chip
                  @click="statusOnChange('Rejected', promotion.header_id)"
                  variant="flat"
                  color="red"
                  class="mx-1"
                >
          ...
          <v-window-item :value="2" class="p-3">
            <v-card
              ...
              v-for="(promotion, index) in promotions_ar"
              :key="index"
              :style="
                'border-color:' + getStatusColor(promotion.approval_status)
              "
...
export default {
  ...
  methods: {
    ...
    fetchpromotionsDetails() {
      this.loader = true;
      this.$axios
        .get(process.env.VUE_APP_API_URL_ADMIN + "fetch-promotions-details", {
          params: {
        ...
        .then((res) => {
          ...
          if (res.data.status == "S") {
            this.promotions_en = res.data.promotions_en;
            this.promotions_ar = res.data.promotions_ar;
            this.loader = false;
          } else {
